...
var spotipi = (function() {
	...
	var port    		= 3000,
		...
		//modularised playlist manager
		playlistManager = require('./lib/playlist')(
			databases,
			socket,
			io
		),
		...
		// market is hardcoded for now
		// @todo should come from user's account data
		markets 		= ['GB'],
	...
	function playTrack(trackData) {
		...
		//
		playlistManager.add(zoneId, trackData.track, function (err, playlist) {
